...
public class AIService {
    ...
    public AIInsightResponse generateMonthlyInsight(String portfolioSummary) {
        ...
        return AIInsightResponse.builder()
                ...
                .actionChecklist(Arrays.asList(
                        "Transfer $5,000 from Current Account to High Yield Savings.",
    ...
    public CashFlowResponse predictCashFlow(String historicalData) {
        ...
        return CashFlowResponse.builder()
                ...
                .AIRecommendation("Your forecasted cash flow is healthy, bolstered by your expected monthly salary. Outflows are projected to spike around rent dates; keep a buffer of $1,500 in current accounts to cover recurring automatic clearing houses.")
                .build();
    }
